...
1 - Run the lightningcash node with txindex=1 , rpcserialversion=0 and rpcworkqueue=1024  !!!

2 - Works and tested with Ubuntu 18.04 only !!!

Otherwise I cannot garantee it will work !
...
This installs electrumx using the default options:
    ...
    wget https://github.com/MerlinMagic2018/electrumx-installer/blob/master/bootstrap.sh -O - | bash
...
For example:
    ...
    wget https://github.com/MerlinMagic2018/electrumx-installer/blob/master/bootstrap.sh -O - | bash -s - -d /media/ssd/electrum-db
